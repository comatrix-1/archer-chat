...
export function mapToLocationType(type: string | undefined): LocationType {
  ...
  if (
    upperType &&
    Object.values(LocationType).includes(upperType as LocationType)
  ) {
...
export function mapToSkillCategory(
  ...
  if (
    upperCategory &&
    Object.values(SkillCategory).includes(upperCategory as SkillCategory)
  ) {
...
export function mapToSkillProficiency(
  ...
  if (
    proficiency &&
    Object.values(SkillProficiency).includes(proficiency as SkillProficiency)
  ) {
  ...
  if (
    upperProficiency &&
    Object.values(SkillProficiency).includes(
      upperProficiency as SkillProficiency,
    )
  ) {
